            ...
            <div className="max-w-5xl mx-auto space-y-8">
              ...
              <div className="bg-blue-600 rounded-xl shadow p-6 flex flex-col md:flex-row items-center transition-transform transform hover:scale-105">
                ...
                <div className="text-white text-center md:text-left">
                  ...
                  <p className="text-base italic">{currentUser.university || "University not specified"}</p>
                </div>
              </div>

              {/* Contact Info Section */}
              <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
                <h2 className="text-2xl font-semibold border-b pb-2 text-gray-800">Contact Info</h2>
              ...
              <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-shadow space-y-4">
                <h2 className="text-2xl font-semibold border-b pb-2 text-gray-800">Interests</h2>
                ...
                {interests.length > 0 && (
                  <div className="mt-4">
                    <h3 className="text-lg font-medium text-gray-800">Selected Interests</h3>
